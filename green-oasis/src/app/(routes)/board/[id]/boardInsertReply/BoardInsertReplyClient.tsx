...
export const BoardInsertReplyClient: React.FC<BoardDetailProps> = ({boardDetail}) => {
    ...
    const handleSave = async () => {
        try {
            ...
            const insertData = {
                ...
                upBoardId: boardDetail.BOARD_ID,
            };
            const flag = "reply";
            const result = await boardService.insertBoard(flag, insertData);
            if (result > 0) {
            ...
            <div className="content-wrapper" >
                <div className="sub-cont">
                    <div className="page-title-box">
                        <div className="left">
                            <h2 className="title">게시판 댓글 등록</h2>
                        </div>
                        <div className="right">
                            <div>
                                <ol className="breadcrumb m-0">
                                    ...
                                    <li className="breadcrumb-item active">게시판 댓글 등록</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
export default BoardInsertReplyClient;
